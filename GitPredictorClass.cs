...
namespace PowerShell.Net
{
    public class GitPredictor : ICommandPredictor
    {
        private readonly Guid _guid;

        internal GitPredictor(string guid)
        {
            _guid = new Guid(guid);
        }
        ...
        /// </summary>
        public string Name => "GitPredictor";

        /// <summary>
        /// Gets the description of a subsystem implementation.
        /// </summary>
        public string Description => "Most often used git commands";
    ...
    public class Init : IModuleAssemblyInitializer, IModuleAssemblyCleanup
    {
        ...
        {
            var predictor = new GitPredictor(Identifier);
